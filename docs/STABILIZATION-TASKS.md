...
## M2-I — 扩展 IT（IT-X · 非 Gate 阻塞）（T-1830-xx）· **defer / 部分 superseded**

> 放行允许 ≤3 条 defer（非安全类）。**T-1890-08**：本批 **整批 defer**（放行后维护）。**DOC-05（2026-08-04）**：与四壳 / `ui.route` 绑定的 IT（如 IT-08 扩测）标 **superseded**，勿再维护；下表其余项仍 defer。
