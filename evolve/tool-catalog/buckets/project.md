...
> L1 · Phase 23 M4。active 工具可通过 `run_evolved` 调用；experimental 工具仅记录能力，未进入默认工具清单。
...
| `structured_test` | **active**：统一测试 status/exit/duration/failures/rerun；底层复用 `run_project_tests` |
